...
famd_u <- cval_mixed_clust(ml100k, ml100k_dem, 10, 3, krange, gen_acos_sim,
                           mean_centered, famd)
mrk_u <- cval_mixed_clust(ml100k, ml100k_dem, 10, 3, krange, gen_acos_sim,
...
mrk_i <- cval_mixed_clust(ml100k, ml100k_feat_d, 10, 8, krange, gen_acos_sim,
