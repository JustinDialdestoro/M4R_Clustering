...
kproto_i <- cval_mixed_clust(ml100k, ml100k_feat_b, 10, 5, krange, gen_acos_sim,
                             mean_centered, kprototypes, FALSE)
mk_i <- cval_mixed_clust(ml100k, ml100k_feat_c, 10, 6, krange, gen_acos_sim,
                         mean_centered, mixed_k, FALSE)
msk_i <- cval_mixed_clust(ml100k, ml100k_feat_d, 10, 5, krange, gen_acos_sim,
                          mean_centered, mskmeans, FALSE)
famd_i <- cval_mixed_clust(ml100k, ml100k_feat_d, 10, 7, krange, gen_acos_sim,
                           mean_centered, famd, FALSE)
mrk_i <- cval_mixed_clust(ml100k, ml100k_feat_d, 10, 5, krange, gen_acos_sim,
                          mean_centered, mrkmeans, FALSE)
kam_i <- cval_mixed_clust(ml100k, ml100k_feat_b, 10, 5, krange, gen_acos_sim,
